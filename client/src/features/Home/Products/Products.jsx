                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
                    {products.length > 0 ? (
                        products.map((product) => (
                            <div
                                key={product.id}
                                className='bg-white h-[450px] w-[350px] flex flex-col p-6 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl hover:shadow-teal-300 transition-all'>
                                <img
                                ...
                                <div className='flex justify-center'>
                                    {user ? (
                                        <button className='bg-teal-600 text-white px-6 py-2 rounded-lg hover:bg-teal-500 transition duration-300'>
                                            Comprar
                                        </button>
                                    ) : (
