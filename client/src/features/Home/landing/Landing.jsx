...
function Landing() {
    return (
        <>
            {/* Hero */}
            <section id='hero' className='bg-sky-300/60 py-12 md:py-20'>
                <div className='container mx-auto text-center flex flex-col items-center gap-4 md:gap-6 px-4 text-white'>
                    ...
                    <p className='text-base md:text-lg max-w-2xl bg-image-text'>
                    ...
                    <Link
                        to='/AboutUs'
                        className='text-base md:text-lg mt-2 md:mt-4 border border-black rounded-lg px-4 md:px-6 py-2 bg-black text-white hover:bg-white hover:text-black transition-colors'>
            ...
            {/* Productos */}
            <section id='productos' className='py-12 md:py-20 bg-white'>
                <div className='container mx-auto px-4 text-center max-w-4xl shadow-md rounded-lg p-6 md:p-8'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-3 md:mb-4'>Nuestros Productos</h2>
                    ...
                    <Link
                        to='/Products'
                        className='text-sm sm:text-base border border-black rounded-lg px-4 md:px-5 py-1 md:py-2 bg-black text-white hover:bg-white hover:text-black transition-colors'>
                        Ver productos
                    </Link>
                </div>
            </section>
            ...
            {/* Servicios */}
            <section id='servicios' className='py-12 md:py-20 bg-sky-300/60'>
                <div className='container mx-auto px-4 text-center max-w-4xl shadow-md rounded-lg p-6 md:p-8 bg-white'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-3 md:mb-4'>Nuestros Servicios</h2>
                    <p className='text-sm sm:text-base text-gray-700 mb-4 md:mb-6'>
            ...
            <section id='categorias' className='py-12 md:py-20 bg-white'>
                <div className='container mx-auto px-4 text-center max-w-4xl shadow-md rounded-lg p-6 md:p-8'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-3 md:mb-4'>Categorías</h2>
                    <p className='text-sm sm:text-base text-gray-700 mb-4 md:mb-6'>
